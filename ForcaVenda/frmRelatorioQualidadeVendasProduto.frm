...
Begin VB.Form frmRelatorioQualidadeVendasProduto 
   BackColor       =   &H80000018&
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Relatório de Qualidade das Vendas por Produto"
   ClientHeight    =   1935
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   9480
   ...
   End
End
Attribute VB_Name = "frmRelatorioQualidadeVendasProduto"
...
Private Sub cmdGerar_Click()
    ...
    Set lReport = lReportApplication.OpenReport(App.Path & "\Relatorios\relQualidadeVendasProduto.rpt")
    ...
    With frmViewer
        ...
        .Caption = "Relatório de Qualidade das Vendas dos Produtos"
