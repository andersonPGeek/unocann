...
Begin VB.Form frmRelatorioMargensNegativas 
   BackColor       =   &H80000018&
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Relatório de Margens Negativas"
   ClientHeight    =   1905
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   9450
   ...
   End
End
Attribute VB_Name = "frmRelatorioMargensNegativas"
...
Private Sub cmdGerar_Click()
    ...
    Set lReport = lReportApplication.OpenReport(App.Path & "\Relatorios\relProdutosMargensNegativas.rpt")
    ...
    With frmViewer
        ...
        .Caption = "Relatório de Produtos com Margens Negativas"
